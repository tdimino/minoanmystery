# Tom di Mino - Portfolio Index

## Source
- Type: Portfolio Index
- Primary Sources: Portfolio site, presentation decks, LinkedIn, project summaries
- Last Updated: 2026-01-16
- **Research Status**: Verified from published case studies

---

## Overview

Tom's portfolio spans enterprise content strategy, nonprofit tech education, and cutting-edge AI/ML applications. From redesigning websites for the world's largest surgical organization to building AI tools that save JP Morgan $800k/day, each project demonstrates the evolution from traditional content work to cognitive design.

---

## Portfolio by Type

### AI/ML Projects (2024-Present)

| Project | Client | Impact | File |
|---------|--------|--------|------|
...
| Project | Client | Impact | File |
|---------|--------|--------|------|
| engEDU Curriculum | Google | 25% rise in program launches | google-engedu.md |
| napari Learning Platform | Chan Zuckerberg Initiative | 15 modules, 300+ plugins | czi-napari.md |

### Enterprise Content Strategy (2020-2021)

| Project | Client | Impact | File |
|---------|--------|--------|------|
| Website Redesign | American College of Surgeons | 40% member increase, 42% session duration | acs-hugo-cat.md |
| CMS Migration | Dolby Laboratories | 12 page templates, 4+ years in use | dolby-sitecore.md |
...
| **Design Longevity** | 4+ years | Dolby Templates |
| **Learning Modules** | 15 | CZI napari |
| **Plugin Ecosystem** | 300+ | napari community |
...
| **Information Architecture** | ACS, Dolby |
| **CMS/Platform** | Dolby (Sitecore), CZI (Jupyter Book) |

---

## Project Dossiers

| File | Client | Type | Status |
|------|--------|------|--------|
| jpmc-meeting-assist.md | JP Morgan Chase | AI/ML | Complete |
| cognitive-design-mvps.md | Minoan Mystery | AI/ML | Complete |
| google-engedu.md | Google | Curriculum | Complete |
| czi-napari.md | Chan Zuckerberg Initiative | EdTech | Complete |
...
### Thread 1: From Content to Cognitive
Each project builds on the last. Content strategy skills inform prompt engineering. UX research methods apply to LLM evaluation. Curriculum design shapes AI training approaches.

### Thread 2: Measurable Impact
Tom's work produces quantifiable results: revenue, adoption rates, time savings, user growth. Not vanity metrics—business outcomes.

### Thread 3: Cross-Functional Bridge
Every project involves translating between stakeholders: engineers and designers, data scientists and product managers, technical and non-technical audiences.

### Thread 4: Human-Centered AI
...
When visitors ask about Tom's professional capabilities, Kothar draws from these portfolio dossiers to speak with specific examples and metrics. The arc from content strategy to AI engineering shows how the same underlying skills—communication, structure, empathy—apply across domains.

> "We're all after the same things: clean, crisp copy that nails what we do and how we do it, with a human spark to it."
> — tomdimino.com

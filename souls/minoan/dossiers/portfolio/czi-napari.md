...
## Source
- Type: Portfolio
- Primary Sources: Portfolio case study, LinkedIn
- Verification: Published case study, live platform
...
| Aspect | Details |
|--------|---------|
| **Client** | Chan Zuckerberg Initiative (CZI) |
| **Industry** | Nonprofit / Scientific Technology |
| **Duration** | 2021-2022 (8 months) |
| **Tom's Role** | Sr. Content Designer (Co-Lead) |
| **Team** | "Bravo Cohort" - 8 imaging scientists, UX researcher, PM, SWE |
...
| Metric | Result |
|--------|--------|
| **Course Modules** | 15 modules in "napari cell segmentation" course |
| **Workflows** | 3 complete workflows for new users to replicate |
| **Installation Guide** | Extensive Python installation documentation |
| **Plugin Ecosystem** | 300+ plugins on napari-hub.org |
| **Adoption** | Gaining adoption alongside Fiji and CellProfiler |
...
- **Learning Platform**: Jupyter Book-based course on napari cell segmentation
- **15 Modules**: Complete curriculum with extensive Python installation guide
- **3 Workflows**: Practical workflows for new users to replicate
- **Co-Design Documentation**: Mural boards capturing scientist expertise
- **Competitive Analysis**: Research on 12 other learning platforms

---

## Skills Demonstrated

- **Project Management**: 6-month plan, milestones, cross-functional coordination
- **Instructional Design**: Curriculum development for technical audiences
- **Co-Design Facilitation**: Mural workshops with research scientists
- **Technical Writing**: Jupyter Book, Markdown, HTML/CSS
- **Open Source Contribution**: GitHub Issues/PRs
- **Cross-Functional Leadership**: Coordinating scientists, UX, and engineering
...
When visitors ask about Tom's experience with open-source technology, scientific communities, or instructional design, Kothar can point to the napari project:
- Leadership of cross-functional teams (scientists, UX, engineering)
- Ability to learn technical domains (Python, microscopy, napari)
- Open source community engagement
- Delivering under tight deadlines with distributed teams
- The MLP philosophy—minimal *lovable* product

---

## Cross-References
- **Portfolio**: google-engedu.md (similar curriculum work)
- **Biography**: big-tech-era.md (career context)
- **Portfolio**: INDEX.md (portfolio overview)

## RAG Tags
CZI, Chan Zuckerberg Initiative, napari, learning platform, Jupyter Book, imaging science, biology, Python, open source, instructional design, co-design, curriculum, Mural, Bravo Cohort, Sr. Content Designer, 2021, 2022, Tom di Mino, portfolio, case study, nonprofit, scientific, MLP, minimal lovable product

...
- **Research Status**: Verified from portfolio content (ongoing projects)
...
|--------|-------|---------|
| **Model Size** | 70B parameters | Model Deployment |
| **Evaluation Dimensions** | 5 weighted criteria | LLM Evaluation |
| **Inference Hardware** | 4× H100 80GB | Model Deployment |
| **Voice Latency** | Sub-second | Soul Engine |
...
|----------|--------------|
| **ML Frameworks** | TensorRT-LLM, TensorRT 10.x, PyTorch, HuggingFace |
| **Serving** | NVIDIA Triton Inference Server, gRPC |
| **Infrastructure** | Docker, Lambda Labs GPU Cloud |
| **Evaluation** | GPT-4o, Kimi K2, Claude (as judges) |
| **Fine-tuning** | LoRA adapters, rank-64 |
| **Voice** | STT/TTS with barge-in detection, dynamic VAD |
...
| Skill | Application |
|-------|-------------|
| **Functional Programming** | Immutable WorkingMemory, pure cognitive steps |
| **Open Souls Paradigm** | Mental Processes, Subprocesses, dual persistence |
| **Multi-GPU Inference** | Tensor parallelism, LoRA switching |
| **LLM Evaluation** | Multi-dimensional assessment, judge calibration |
| **Voice AI** | Real-time transport, barge-in detection |
| **Production SMS** | Multi-provider abstraction, rate limiting |
...
## Cross-References
- **Biography**: ai-ml-chapter.md (career context, collaborators)

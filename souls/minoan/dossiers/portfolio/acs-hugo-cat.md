...
- Verification: Published case study
...
| Aspect | Details |
|--------|---------|
| **Client** | American College of Surgeons (ACS) |
| **Industry** | Healthcare / Professional Association |
| **Duration** | 2021 (6 months) |
| **Tom's Role** | Lead Sr. Content Strategist |
| **Team** | Hugo & Cat (award-winning agency) |
...
| Metric | Result |
|--------|--------|
| **Member Applications** | 40% increase |
| **Session Duration** | 42% increase in average user session duration |
| **Membership Growth** | From 84,000 to 93,241 members (2022-2024) |
| **Geographic Reach** | 144 countries |
| **Contract Renewal** | ACS renewed with Hugo & Cat for patient-centric content expansion |

---

## Key Deliverables

- **Content Audit**: Comprehensive analysis of ACS.org with prioritization annotations
- **Information Architecture**: Figma rendering of content hierarchy
- **Voice & Tone**: 3 distinct copywriting archetypes for A/B testing
- **Taxonomy**: New navigation and search taxonomy
- **Migration Plan**: Prioritized content for Umbraco migration

---

## Skills Demonstrated

- **Content Audit**: Enterprise-scale website analysis
- **UX Research**: User interviews, A/B testing, prototype testing
- **Information Architecture**: Taxonomy design, navigation structure
- **Voice & Tone Development**: Multiple audience personas (surgeons vs. patients)
- **Stakeholder Management**: C-suite presentations, cross-functional collaboration
- **Co-Design Facilitation**: Crazy Eights, Figma workshops
...
When visitors ask about Tom's content strategy or enterprise work, this case study demonstrates:
- Ability to wrangle complex, legacy content ecosystems
- Research-driven approach with measurable outcomes
- Cross-functional collaboration in agency settings
- 40% and 42% improvements show tangible impact
- The co-design philosophy that carries through to AI work

---

## Cross-References
- **Biography**: agency-years.md (Hugo & Cat context)
- **Portfolio**: INDEX.md (portfolio overview)
- **Portfolio**: dolby-sitecore.md (similar enterprise migration)

## RAG Tags
American College of Surgeons, ACS, Hugo & Cat, content audit, information architecture, taxonomy, voice and tone, UX research, content strategy, Figma, A/B testing, Umbraco, migration, healthcare, medical, enterprise, 40% increase, 42% session duration, membership growth, co-design, Crazy Eights, Sr. Content Strategist, 2021, Tom di Mino, portfolio, case study, Julia Murphy, mentor

...
The Hebrew **תְּהוֹם** (*tehôm*, "the deep") of Genesis 1:2—hovering beneath the darkness before creation—shares cognate status with Akkadian **Tiamat**, the primordial sea-goddess defeated by Marduk in *Enuma Elish*. Both derive from a common Semitic root *\*tihām-* designating the cosmic abyss. This linguistic kinship carries theological weight: the chaos-waters represent a pre-creation state that must be subdued, divided, or ordered for the cosmos to emerge.

The Theran eruption (c. 1628–1500 BCE) inscribed itself into Aegean cultural memory as precisely such a chaos-event: the sea boiling, darkness descending, the boundary between water and land catastrophically violated. When West Semitic colonists named the island Kalliste ("most beautiful") and later Thera, they may have encoded the goddess Athirat—who bears the epithet *Athirat Rahmay* ("Athirat of the Womb/Mercy")—into the volcanic landscape. The phonetic shift from *Athirat* → *Thera* follows documented patterns of initial vowel loss in Greek renderings of Semitic names.

This dossier traces the theological vocabulary of primordial chaos across Mesopotamian, Canaanite, and early Hebrew traditions, proposing that Thera's naming participates in this deep cosmological grammar.

---

## Key Arguments

### 1. Tehom and Tiamat: Cognate Status
...
| Language | Term | Form | Root |
|----------|------|------|------|
| Hebrew | *tehôm* | Noun, usually without article | *\*t-h-m* |
| Akkadian | *tiāmtu* / *tâmtu* | "sea" (common noun) | *\*t-h-m* |
| Akkadian | *Tiāmat* | Goddess name | *\*t-h-m* + divine marker |
| Ugaritic | *thm* | "deep, ocean" | *\*t-h-m* |
| Arabic | *tihāma* | Coastal lowland (Tihama) | *\*t-h-m* |

The shared Semitic root *\*t-h-m* designates salt-water oceanic depths. Hebrew *tehôm* appears without the definite article in most occurrences (36 of 37), suggesting it retained traces of a proper-name quality—the personified Deep.

### 2. Tiamat in Enuma Elish

**Tablet I** establishes the primordial state:
> "When on high the heaven had not been named, firm ground below had not been called by name, naught but primordial **Apsû**, their begetter, and **Tiamat**, she who bore them all, their waters commingling as a single body..."

**Tablet IV** describes Marduk's victory:
> "He split her like a shellfish into two parts: half of her he set up and ceiled as sky, pulled down the bar and posted guards."

The cosmogonic pattern: chaos-waters must be divided for creation. This matches Genesis 1:6–7 (dividing waters above from waters below) without direct mythological combat.

### 3. Tiamat Beyond Enuma Elish

Tiamat appears in non-combative contexts:

**Lexical lists**: *tiāmtu* simply means "sea" in administrative and literary texts, without cosmic significance.

**Theogonic contexts**: Tiamat as mother-goddess, generative rather than adversarial. The *Enuma Elish* combat tradition represents one strand of a more complex tradition.
...
| Phenomenon | Mythological Encoding |
|------------|----------------------|
| Pyroclastic darkness | "Pall of Darkness" (Apollonius) |
| Tsunami waves | "Deep" rising, boundary violations |
| Ash clouds blocking sun/moon | "Stars pierced not that fatal night" |
| Caldera collapse | Waters overwhelming land |
...
**KTU 1.4 IV.49** (Ugaritic, Baal Cycle):
> "Message of Lady Athirat of the Sea (*rbt ʾaṯrt ym*), word of the Creatrix of the gods (*qnyt ʾilm*)..."

**Apollonius Rhodius, *Argonautica* IV.1694–98**:
The "Pall of Darkness" passage—cosmogonic vocabulary applied to the Cretan sea near Thera.

### Scholarly Support

**Hermann Gunkel** (*Schöpfung und Chaos*, 1895): First systematic argument for Genesis 1 depending on Mesopotamian chaos-combat mythology, though without direct literary dependence.

**Cyrus Gordon**: Noted that Ugaritic *thm* serves as cognate bridge between Akkadian Tiamat and Hebrew *tehôm*.

**Astour**: Connected Membliaros ("waters without light") to Phoenician cosmogony, demonstrating cosmogonic vocabulary at Thera.
...
- [membliaros-cadmean-etymology.md](./membliaros-cadmean-etymology.md) — Cosmogonic name at Thera
...
|---------|------|------|--------------|
| Gunkel, Hermann | *Schöpfung und Chaos in Urzeit und Endzeit* | 1895 | Genesis–Tiamat connection |
| Gordon, Cyrus H. | *Ugaritic Textbook* | 1965 | *thm* cognate analysis |
| Astour, Michael C. | "Greek Names in the Semitic World" | 1964 | Membliaros cosmogony |
